...
User Documentation
==================
User-level documentation, found at the link below, is aimed at personnel looking to perform the standard use-cases/operations with the [CSC].
...
The configuration for the [CSC] is described at the following link.
...
The version history of the [CSC] is found at the following link.
