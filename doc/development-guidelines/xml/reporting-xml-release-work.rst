...
If there is no description on the ticket, please publicly shame the reporter on the ``#cap-software`` Slack channel to have one written. Make sure to reference the offending ticket.
