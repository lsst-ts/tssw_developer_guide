...
The simplest way to create a new repository is to use Squarebot on Slack.
...
Click on the "+" sign, search for Squarebot and start a chat with it.
Send a message with "create project" to the bot and follow the prompts to have the repository automatically created and setup for you.

.. image:: /images/squarebot-1.png

Then pick the template ``LSST EUPs Package``

.. image:: /images/squarebot-2.png
...
Once you have created the repository with its initial commit (either with squarebot or manually with the template kit), you need to set it up to follow our :ref:`workflow <development_workflow>`.
